...
indexerTrainGd = 1;
for lr = 0.4:0.1:0.7    
        traingdRes(indexerTrainGd, :) = validationTesting(trainingSize, x, y, l, 'traingd', lr);
...
% for lr = 0.01:0.01:0.1 
%     for mc = 0: 0.1: 1
%         traingdmRes(indexerTrainGdm, :) = validationTesting(trainingSize, x, y, l, 'traingdm', lr, mc);
...
%             trainrpRes(indexerTrainRp, :) = validationTesting(trainingSize, x, y, l, 'trainrp', lr, delt_inc, delt_dec);
